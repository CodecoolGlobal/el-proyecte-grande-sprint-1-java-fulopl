...
VALUES (1, (date_trunc('week', current_date) + interval '0 day')::date, (date_trunc('week', current_date) + interval '6 days')::date, EXTRACT(week FROM current_date), EXTRACT(year FROM current_date)),
       (2, (date_trunc('week', current_date) + interval '7 days')::date, (date_trunc('week', current_date) + interval '13 days')::date, EXTRACT(week FROM current_date + interval '7 days'), EXTRACT(year FROM current_date + interval '7 days')),
       (3, (date_trunc('week', current_date) + interval '14 days')::date, (date_trunc('week', current_date) + interval '20 days')::date, EXTRACT(week FROM current_date + interval '14 days'), EXTRACT(year FROM current_date + interval '14 days'));
